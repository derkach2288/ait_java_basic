...
public class Main {
    /*
    Дано два списка User. Реализовать метод List<String>
    findDuplicates(Collection<String> collA,Collection<String> collB)
    ...
    public static List<String> findDuplicates(Collection<String> collA, Collection<String> collB){
        ...
        setA.retainAll(setB); // оставляет только дубликаты
